    ...
    return (
        <div className="relative min-h-screen flex justify-center items-center">
            ...
            <div
                ...
                className="relative bg-white bg-opacity-90 shadow-lg rounded-2xl w-[300px] sm:w-[280px] p-4"
            >
                <div className="flex flex-col items-center justify-center space-y-2 mb-3">
                    <Link href="/" className="flex items-center no-underline">
                        <Image src={logoImage} alt="Logo" width={30} height={30} className="mr-2 rounded-full"/>
                        <span className="font-semibold text-base text-gray-800">SG-FIX</span>
                    </Link>
                    <h2 className="text-sm font-semibold text-gray-700 mt-3">Sign in</h2> {/* Ajout de mt-3 */}
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            >
                                {showPassword ? <FaEyeSlash /> : <FaEye />} {/* Utilisation des icônes */}
                            </button>
                        </div>
                    </div>
